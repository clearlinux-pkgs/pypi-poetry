...
Source0  : https://files.pythonhosted.org/packages/6b/ed/57f55c650cb61310ac15df2b694d41dfb45c33480c3394410a911b847971/poetry-1.3.2.tar.gz
...
%prep
%setup -q -n poetry-1.3.2
cd %{_builddir}/poetry-1.3.2
%patch1 -p1
pushd ..
cp -a poetry-1.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673386775
