...
Source0  : https://files.pythonhosted.org/packages/d6/75/2603419dcfafb3e777b304c9cb2813a8a4090db04356b750a662663c3c01/poetry-1.2.0.tar.gz
...
%prep
%setup -q -n poetry-1.2.0
cd %{_builddir}/poetry-1.2.0
pushd ..
cp -a poetry-1.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661967828
