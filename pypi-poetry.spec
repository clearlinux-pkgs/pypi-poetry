...
Source0  : https://files.pythonhosted.org/packages/49/a7/f5fbce21ed8e5871c229864e9c2b588897e1aeb9431f024636252069245b/poetry-1.8.2.tar.gz
...
%prep
%setup -q -n poetry-1.8.2
cd %{_builddir}/poetry-1.8.2
pushd ..
cp -a poetry-1.8.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710600390
